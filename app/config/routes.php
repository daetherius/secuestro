...
Router::connect('/como_prevenir/:category',array('controller'=>'tips','action'=>'index'),$regex);
Router::connect('/como_prevenir/:category/:action/*',array('controller'=>'tips','action'=>':action'),$regex);
